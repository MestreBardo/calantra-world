---
{"publish":true,"title":"Elathor","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/elfo","status/desconhecido"],"cssclasses":"character-page"}
---
...
![[Imagens/Pessoas/Elfos/Elathor.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação              |
| -------------------------- | ----------------------- |
| **Nome Completo**          | Elathor                 |
| **Títulos/Apelidos**       | -                       |
...
> |------------|------|----------------|--------|
> | Filho | [[Pessoas/Elfos/Caspar]] | Relação paternal | 🟢 Vivo |
