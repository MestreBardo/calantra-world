---
{"publish":true,"title":"Naruda","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/gnomo","status/vivo"],"cssclasses":"character-page"}
---
...
![[Imagens/Pessoas/Gnomos/Naruda.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação                      |
| -------------------------- | ------------------------------- |
| **Nome Completo**          | Naruda                          |
| **Títulos/Apelidos**       | -                               |
| **Ancestralidade/Espécie** | [[Ancestralidades/Gnomos\|Gnoma]]               |
| **Gênero**                 | Feminino                        |
| **Idade**                  | XX anos (aparente/real)         |
| **Status**                 | 🟢 Vivo                         |
| **Ocupação**               | Garçonete da taverna "O Barril" |
