---
{"publish":true,"title":"O Imperador","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/anão","status/desconhecido"],"cssclasses":"character-page"}
---
...
![[Imagens/Pessoas/Anãos/O Imperador.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação               |
| -------------------------- | ------------------------ |
| **Nome Completo**          | O Imperador              |
| **Títulos/Apelidos**       | -                        |
| **Ancestralidade/Espécie** | [[Ancestralidades/Anãos\|Anão]]          |
| **Gênero**                 | Masculino/Feminino/Outro |
| **Idade**                  | XX anos (aparente/real)  |
| **Status**                 | ❓ Desconhecido           |
| **Ocupação**               | Líder do Império Anão    |
| **Local Atual**            | -                        |
