---
{"publish":true,"title":"Scarlet Queen","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/anão","status/vivo"],"cssclasses":"character-page"}
---
...
![[Imagens/Pessoas/Anãos/Scarlet Queen.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação                       |
| -------------------------- | -------------------------------- |
| **Nome Completo**          | Scarlet Queen                    |
| **Títulos/Apelidos**       | -                                |
| **Ancestralidade/Espécie** | [[Ancestralidades/Anãos\|Anão]]                  |
| **Gênero**                 | Outro                            |
| **Idade**                  | XX anos (aparente/real)          |
| **Status**                 | 🟢 Vivo                          |
| **Ocupação**               | Dono do bordel O Segredo da Ilha |
