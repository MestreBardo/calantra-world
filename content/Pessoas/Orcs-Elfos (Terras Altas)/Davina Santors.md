...
![[Imagens/Pessoas/Orcs-Elfos (Terras Altas)/Davina GIGANTA Santors.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação                 |
| -------------------------- | -------------------------- |
| **Nome Completo**          | Davina Santors             |
| **Títulos/Apelidos**       | Giganta                    |
| **Ancestralidade/Espécie** | [[Ancestralidades/Elfos-Orcs\|Terra Alta]] |
| **Gênero**                 | Feminino                   |
