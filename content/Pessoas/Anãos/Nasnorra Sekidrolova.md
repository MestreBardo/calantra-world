---
{"publish":true,"title":"Nasnorra Sekidrolova","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/anão","status/vivo"],"cssclasses":"character-page"}
---
...
| Campo                      | Informação                       |
| -------------------------- | -------------------------------- |
| **Nome Completo**          | Nasnorra Sekidrolova             |
| **Títulos/Apelidos**       | -                                |
| **Ancestralidade/Espécie** | [[Ancestralidades/Anãos\|Anã]]                   |
| **Gênero**                 | Feminino                         |
| **Idade**                  | XX anos (aparente/real)          |
| **Status**                 | 🟢 Viva                          |
| **Ocupação**               | Musicista da Taverna da Esquerda |
