---
{"publish":true,"title":"Nordrer Sekidrolov","draft":"false","created":"2025-06-26","tags":["pessoa","ancestralidade/anão","status/vivo"],"cssclasses":"character-page"}
---
...
![[Imagens/Pessoas/Anãos/Nordrer Sekidrolov.webp|300]]

## 📋 Informações Básicas

| Campo                      | Informação                       |
| -------------------------- | -------------------------------- |
| **Nome Completo**          | Nordrer Sekidrolov               |
| **Títulos/Apelidos**       | -                                |
| **Ancestralidade/Espécie** | [[Ancestralidades/Anãos\|Anão]]                  |
| **Gênero**                 | Masculino                        |
| **Idade**                  | XX anos (aparente/real)          |
| **Status**                 | 🟢 Vivo                          |
| **Ocupação**               | Taverneiro da Taverna da Esqueda |
...
> |------------|------|----------------|--------|
> | Filha | [[Pessoas/Anãos/Nasnorra Sekidrolova]] | Relação paternal | 🟢 Vivo |
